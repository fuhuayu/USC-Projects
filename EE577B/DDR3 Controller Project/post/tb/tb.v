...
module tb();
`define IPNUT_FILE_NAME "./tb/ddr3_test_pattern7_Atomic.dat" //Please MANUALLY modify the test pattern name
`define TRACE_FILE_NAME "ddr3_test.trc"  //Not used
`define DUMP_FILE_NAME  "ddr3_test_pattern.dump" // Please MANUALLY modify the dump file name
