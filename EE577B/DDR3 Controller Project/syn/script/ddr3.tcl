...
set_dont_touch [ find cell process_logic_ddr3/ring_buffer/DELAY*]
get_attribute [ find cell process_logic_ddr3/ring_buffer/DELAY*] dont_touch

# set_dont_touch [ find cell XINIT/DELAY*]
# get_attribute [ find cell XINIT/DELAY*] dont_touch
...
set_input_delay 0.3 -max -clock clk [remove_from_collection [all_inputs] [get_ports "clk"]] ;
